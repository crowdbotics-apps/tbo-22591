...
admin.site.site_header = "TBO"
admin.site.site_title = "TBO Admin Portal"
admin.site.index_title = "TBO Admin"

# swagger
api_info = openapi.Info(
    title="TBO API",
    default_version="v1",
    description="API documentation for TBO App",
)
